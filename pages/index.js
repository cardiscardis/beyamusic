...
export default function Home() {
  return (
    <>
      ...
      <Playlist />
      <div class="row">
          <div class="col-sm-6 col-lg-6 p-5 rouded" style={{background: "#178037", color: "#fff"}}>
              <h3 class="mb-2" style={{color: "#fff"}}>Calling all creators</h3>
          ...
          <div class="col-sm-6 col-lg-6" style={{backgroundImage: "url(../images/cover/contetcreator.png)", backgroundPosition: "center", backgroundSize: "cover"}}></div>
      </div>
      <Player />
      <div id="backdrop"></div>
    </>
