                ...
                <div className="row">
                    <div className="col-xl-6">
                        ...
                        data-song-cover="images/cover/small/1.jpg">
                            ...
                            <ul className="list__option">
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="1">
                        ...
                        data-song-cover="images/cover/small/2.jpg">
                            ...
                            <ul className="list__option">
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="2">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                        ...
                        data-song-cover="images/cover/small/3.jpg">
                            ...
                            <ul className="list__option">
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="3">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                        ...
                        data-song-cover="images/cover/small/4.jpg">
                            ...
                            <ul className="list__option">                                       
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="4">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                        ...
                        data-song-cover="images/cover/small/5.jpg">
                            ...
                            <ul className="list__option">  
                                ...
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="5">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                    ...
                    <div className="col-xl-6">
                        ...
                        data-song-cover="images/cover/small/6.jpg">
                            ...
                            <ul className="list__option">                                        
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="6">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                        ...
                        data-song-cover="images/cover/small/7.jpg">
                            ...
                            <ul className="list__option">    
                                ...
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="7">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                        ...
                        data-song-cover="images/cover/small/8.jpg">
                            ...
                            <ul className="list__option">    
                                ...
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="8">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                        ...
                        data-song-cover="images/cover/small/9.jpg">
                            ...
                            <ul className="list__option">                                      
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="9">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
                        ...
                        data-song-cover="images/cover/small/10.jpg">
                            ...
                            <ul className="list__option">                                        
                                <li>
                                    <a href="javascript:void(0);" role="button" className="d-inline-flex active" aria-label="Favorite" data-favorite-id="10">
                                        <i className="ri-heart-line heart-empty"></i>
                                        <i className="ri-heart-fill heart-fill"></i>
                                    </a>
                                </li>
