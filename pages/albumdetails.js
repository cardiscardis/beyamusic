                    ...
                    <div className="d-flex flex-wrap mb-2">
                        ...
                        <div className="dropstart d-inline-flex ms-auto">
                            ...
                            <ul className="dropdown-menu dropdown-menu-sm">
                                <li><a className="dropdown-item" href="javascript:void(0);" role="button">Add to playlist</a></li>
                                <li><a className="dropdown-item" href="javascript:void(0);" role="button">Add to queue</a></li>
                                <li><a className="dropdown-item" href="javascript:void(0);" role="button">Next to play</a></li>
        ...
        <div className="section">
            <div className="section__head">
                <div className="flex-grow-1">
                    <h3 className="mb-0">Related <span className="text-primary">Albums</span></h3>
                </div>
            ...
            <div className="swiper-carousel swiper-carousel-button">
                <div className="swiper swiper-initialized swiper-horizontal swiper-pointer-events" data-swiper-slides="5" data-swiper-autoplay="true">
                    <div className="swiper-wrapper" id="swiper-wrapper-8923222fb5788e8b" aria-live="off" style={{transform: "translate3d(0px, 0px, 0px)", transitionDuration: "0ms"}}>
                ...
                <div className="swiper-button-prev btn-default rounded-pill swiper-button-disabled" tabIndex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-8923222fb5788e8b" aria-disabled="true"></div>
                <div className="swiper-button-next btn-default rounded-pill" tabIndex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-8923222fb5788e8b" aria-disabled="false"></div>
            </div>
