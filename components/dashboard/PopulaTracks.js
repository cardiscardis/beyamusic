            ...
            <div class="section">
                <div class="section__head">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">Popular <span class="text-primary"> Tracks</span></h3>
                    </div>
                </div>
                ...
                <div class="swiper-carousel swiper-carousel-button">
                    ...
                    <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events" data-swiper-slides="5" data-swiper-autoplay="true">
                        <div class="swiper-wrapper" id="swiper-wrapper-8949c127d1c710fe0" aria-live="off" style={{transform: "translate3d(0px, 0px, 0px)", transitionDuration: "0ms"}}>
                    ...
                    <div class="swiper-button-prev btn-default rounded-pill swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-8949c127d1c710fe0" aria-disabled="true"></div>
                    <div class="swiper-button-next btn-default rounded-pill" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-8949c127d1c710fe0" aria-disabled="false"></div>
                </div>
