...
const DashboardTable = () => {
    return (
        ...
        <div className="row">
            ...
            <div className="cover cover--round shadow-sm p-3 mb-5 bg-white rounded" style={{backgroundColor: "#fff"}}>
        ...
        <div className="row">
            <div className="col-lg-4 col-sm-6">
                <div className="cover cover--round shadow-sm p-3 mb-5 rounded" style={{backgroundColor: "#178037"}}>
                    ...
                    <button type="button" className="btn btn-light w-100">Windraw</button>
                    </div>
                </div>
            </div>
